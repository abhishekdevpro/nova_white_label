...
function ForEmployer({ forEmployerData, projectName }) {
  ...
  useEffect(() => {
    ...
    console.log(
      "forEmployerData",
      typeof (forEmployerData.is_images_display)[0]
    );
    setShowImage((forEmployerData.is_images_display)[0] === "true");
    if (forEmployerData.images && (forEmployerData.images)) {
      const imgData = (forEmployerData.images);
