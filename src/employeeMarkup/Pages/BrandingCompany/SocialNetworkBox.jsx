...
const SocialNetworkBox = () => {
  ...
  const { companyData, setCompanyData, handleInputChange, fetchCompanyData, handleSave, handleAboutSave } =
    useCompanyData()
                ...
                <div className="col-xl-9 col-lg-9 m-b30">
                  <div className="job-bx submit-resume">
                    <div className="job-bx-title clearfix">
                      <h5 className="font-weight-700 pull-left text-uppercase">Company Branding</h5>
                    </div>
                    <form>
