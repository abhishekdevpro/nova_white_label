    ...
    const fetchPageData = async () => {
      try {
        const response = await axios.get(
          `https://apiwl.novajobs.us/api/jobseeker/terms-and-condition?domain=${url}`
        );
              ...
              <div className="container">
                <div className="m-b30">
                  <div className="job-bx">
                    ...
                    >
                      Terms of Use for Nova US Jobs
                    </h1>
                    <p>
                      Welcome to Nova US Jobs (the "Website"). These Terms of
                      Use ("Terms") govern your access to and use of the
                      Website. By accessing or using the Website, you agree to
                      comply with these Terms. If you do not agree with these
                      Terms, you should not access or use the Website.
                    </p>
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        ...
                        by these Terms and any additional terms and conditions
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        The Website is provided for informational purposes and
                        to facilitate job searching and hiring. You agree to use
                        the Website only for lawful purposes and in accordance
                        with these Terms. You are responsible for ensuring that
                        your use of the Website complies with all applicable
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        In order to access certain features of the Website, you
                        ...
                        to ensure its accuracy. You are responsible for
                        maintaining the confidentiality of your account and
                        password and for restricting access to your account. You
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        You may have the opportunity to submit content to the
                        Website, such as job postings or resumes. By submitting
                        content to the Website, you grant Nova US Jobs a
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        ...
                        thereof) are owned by Nova US Jobs, its licensors, or
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        ...
                        only and do not imply any endorsement by Nova US Jobs of
                        such third-party websites or resources. You acknowledge
                        and agree that Nova US Jobs is not responsible or liable
                        for the availability or accuracy of such websites or
                        resources, or for any content, products, or services
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        ...
                        law, nova us jobs disclaims all warranties, express or
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        In no event shall nova us jobs, its affiliates, or their
                        licensors, service providers, employees, agents,
                        officers, or directors be liable for any indirect,
                        special, incidental, consequential, or punitive damages,
                        arising out of or in connection with your use of the
                        website or any content, products, or services made
                        available through the website, whether based on
                        warranty, contract, tort (including negligence), or any
                        other legal theory, even if nova us jobs has been
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        You agree to indemnify, defend, and hold harmless Nova
                        US Jobs, its affiliates, licensors, and service
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        ...
                        State of [South Carolina], without giving effect to any
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        Nova US Jobs reserves the right to modify or revise
                        these Terms at any time, in its sole discretion, by
                        posting the revised Terms on the Website. Your continued
                    ...
                    <div className="candidate-title">
                      ...
                      <p className="mb-0">
                        ...
                        contact us at contact@novausjobs.com.
                      </p>
                    </div>
                    <div className="candidate-title">
                      <p className="mb-0">
                        By using Nova US Jobs, you acknowledge that you have
