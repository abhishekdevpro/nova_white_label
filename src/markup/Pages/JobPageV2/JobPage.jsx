...
function JobPage() {
  ...
  const fetchJobApplicationData = async () => {
    try {
      ...
      params.append("sort_order",sortBy);
      ...
      if (searchParams.workplace_type)
        params.append("workplace_type", searchParams.workplace_type);
      if (searchParams.job_type)
        params.append("job_type", searchParams.job_type);
      if (searchParams.experience_level)
        params.append("experience_level", searchParams.experience_level);
      if (searchParams.title_keywords)
        params.append("title_keywords", searchParams.title_keywords);
      if (searchParams.company_id)
        params.append("company_id", searchParams.company_id);
  ...
  }, [dispatch, token, page, perPage, searchParams, url,sortBy]);
