                  ...
                  <div className="job-bx table-job-bx clearfix">
                    ...
                    <div className="row justify-content-center g-4">
                      <div className="col-md-6 col-sm-12">
                        <div className="card border w-100 p-3 rounded-5" style={{ 
                          fontSize: '1.2rem', 
                          fontWeight: '500', 
                          color: 'white', 
                          ...
                          <div className="card-body text-center">
                            <FontAwesomeIcon icon={faCloudUploadAlt} className="me-2 mb-3" style={{ fontSize: '2rem' }} />
                            <h5 className="card-title mb-4">Upload Bulk Job Opening</h5>
                      ...
                      <div className="col-md-6 col-sm-12">
                        <div className="card border w-100 p-3 rounded-5" style={{ 
                          ...
                          <div className="card-body text-center">
                            <FontAwesomeIcon icon={faFileDownload} className="me-2 mb-3" style={{ fontSize: '2rem' }} />
                            <h5 className="card-title mb-4">Download Our Template</h5>
                            <a
                              href={csd}
